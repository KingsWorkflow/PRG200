...
class DeliveryPartner:
    ...
    def display(self):
        print(f"{self.name} ({self.partner_id}): {self.deliveries} deliveries, "
              f"Earning = NPR {self.total_earning():.2f}")
...
print(f"Highest earner: {top.name} with NPR {top.total_earning():.2f}")
